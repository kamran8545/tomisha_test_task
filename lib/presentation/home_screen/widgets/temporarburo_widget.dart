...
class TemporarburoWidget extends StatelessWidget {
  const TemporarburoWidget({super.key});
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.end,
            children: [
              SizedBox(width: isTablet ? 180.w : 217.w, height: isTablet ? 120.h : 147.h, child: AppIcons.jobOffersSVG),
              SizedBox(width: isTablet ? 20 : 122.w),
              Text(
                '2. ',
                style: TextStyle(
                  fontSize: isTablet ? 100 : 130.sp,
                  fontWeight: FontWeight.w500,
                  color: AppColors.textLight2Color,
                  height: 1,
                ),
              ...
              Flexible(
                child: Text(
                  'Erhalte Vermittlungs-angebot bon Arbeitgeber',
                  style: TextStyle(fontSize: isTablet ? 24 : 30.sp, fontWeight: FontWeight.w500, color: AppColors.textLight2Color),
                ),
              ),
            ],
          ),
        ...
        Row(
          ...
          children: [
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text(
                      isTablet ? 'Vermittlung nach\nProvision oder\n Stundenlohn' : 'Vermittlung nach Provision oder Stundenlohn',
                      style: TextStyle(
            ...
            SizedBox(width: isTablet ? 0 : 62.w),
            SizedBox(width: 250.w, height: 190.h, child: AppIcons.businessDealSVG),
          ],
        ),
        ...
        Container(
          ...
          child: Stack(
            children: [
              ...
              Positioned(top: 120.h, left: 100.w, child: SizedBox(width: 259.w, height: 179.h, child: AppIcons.jobOffersSVG)),
            ],
          ),
        ),
        SizedBox(
          ...
          child: Stack(
            ...
            children: [
              ...
              Container(
                ...
                child: SizedBox(width: 281.w, height: 210.h, child: AppIcons.businessDealSVG),
              ),
            ],
          ),
        ),
